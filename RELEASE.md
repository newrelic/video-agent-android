...
| **Publish** | `publish.yml` | Merge release PR | Creates Git tag + GitHub Release + Deletes release branch |
...
| `.github/workflows/publish.yml` | Creates Git tag, GitHub Release, deletes release branch |
