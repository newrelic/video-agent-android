...
| segmentDownloadBitrate   | Observed Bitrate: The actual, empirical throughput measured in bits per second across all downloaded media.                                         |
| networkDownloadBitrate   | The actual download throughput in bits per second.                                                                                                 |
